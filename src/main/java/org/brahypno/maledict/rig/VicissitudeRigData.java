...
public final class VicissitudeRigData {
    ...
    public enum Joint {
        ...
        WING_LEFT_FEATHER_1(WING_LEFT_FEATHERS, -19.0F, 1.0F, 0.0F),
        WING_LEFT_FEATHER_2(WING_LEFT_FEATHERS, -9.0F, 1.0F, 0.0F),
        WING_LEFT_FEATHER_3(WING_LEFT_FEATHERS, 0.75F, 1.0F, 0.0F),
        WING_LEFT_FEATHER_4(WING_LEFT_FEATHERS, 7.25F, 1.0F, 0.0F),
        ...
        WING_RIGHT_FEATHER_1(WING_RIGHT_FEATHERS, 19.0F, 1.0F, 0.0F),
        WING_RIGHT_FEATHER_2(WING_RIGHT_FEATHERS, 9.0F, 1.0F, 0.0F),
        WING_RIGHT_FEATHER_3(WING_RIGHT_FEATHERS, -0.75F, 1.0F, 0.0F),
        WING_RIGHT_FEATHER_4(WING_RIGHT_FEATHERS, -7.25F, 1.0F, 0.0F),
